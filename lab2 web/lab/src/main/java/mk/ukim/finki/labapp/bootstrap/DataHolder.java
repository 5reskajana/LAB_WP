...
public class DataHolder {
    ...
    public void init(){
        ...
        artists.add(new Artist(1L, "Cane", "Nikolovski", "cane cane"));
        artists.add(new Artist(2L,  "name2", "surname2", "artist2"));
        artists.add(new Artist(3L,  "name3", "surname3", "artist3"));
        artists.add(new Artist(4L,  "name4", "surname4", "artist4"));
        artists.add(new Artist(5L,  "name5", "surname5", "artist5"));
