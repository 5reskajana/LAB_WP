...
public class WebSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user1 = User.builder().username("j.petreska").password(passwordEncoder.encode("jp")).roles("USER").build();
        UserDetails user2 = User.builder().username("chombe").password(passwordEncoder.encode("ch")).roles("USER").build();
